...
static class AbbRemoteErrorCodes
{
...
sealed record AbbRemoteRequest(
    string Id,
    string Action,
    string? Ip,
    string? ProgramName,
...
sealed record AbbRemoteResponse(
    string Id,
    bool Ok,
    string Message,
    string[] Log,
...
static class AbbRemoteProtocol
{
