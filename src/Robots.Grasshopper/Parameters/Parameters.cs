...
public class CommandParameter() : Param<Command, GH_Command>(
    "Command",
    "Robot command.",
...
public class RobotSystemParameter() : PreviewParam<RobotSystem, GH_RobotSystem>(
    "Robot System",
...
public class TargetParameter() : Param<Target, GH_Target>(
    "Target",
    "Robot target.",
    "{BEB590A9-905E-42ED-AB08-3E999EA94553}",
    GH_Exposure.secondary);

public class ToolParameter() : Param<Tool, GH_Tool>(
    "Tool",
    "Robot tool.",
    "{073A02A6-2166-4387-9482-2EE3282E9209}",
    GH_Exposure.tertiary);

public class ToolpathParameter() : Param<IToolpath, GH_Toolpath>(
    "Toolpath",
    "Robot toolpath.",
